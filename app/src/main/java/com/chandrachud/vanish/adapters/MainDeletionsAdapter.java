...
public class MainDeletionsAdapter extends RecyclerView.Adapter<MainDeletionsAdapter.MyView>{
    ...
    public MainDeletionsAdapter()
    {

    }

    public MainDeletionsAdapter(Context context, int screenWidth, ArrayList<deletedNumberItem> deletedNumberItems, int[] profileImgList)
    {
    ...
    @Override
    public MainDeletionsAdapter.MyView onCreateViewHolder(ViewGroup parent,
                                                              int viewType)
    {
        ...
        View itemView
                ...
                .inflate(R.layout.delete_item_main_layout,
                        parent,
                        false);

        // return itemView
        return new MainDeletionsAdapter.MyView(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull MainDeletionsAdapter.MyView holder, int position) {
