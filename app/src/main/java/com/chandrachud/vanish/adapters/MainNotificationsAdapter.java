...
public class MainNotificationsAdapter extends RecyclerView.Adapter<MainNotificationsAdapter.MyView> {
    ...
    public MainNotificationsAdapter(Context context, int screenWidth, ArrayList<NotificationManagerItem> managerItems)
    {
                                     ...
                                     int viewType)
    {
        ...
        View itemView
                ...
                .inflate(R.layout.notifications_main_item_layout,
                        parent,
                        false);
